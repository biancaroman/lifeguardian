...
const Chatbot = () => {
  const [messages, setMessages] = useState([
    {
      text: 'Bem-vindo ao suporte da LifeGuardian! Como posso ajudar você?',
      sender: 'chatbot',
    },
  ]);
  ...
  return (
    <main>
      <Header/>
      <div className="flex flex-col items-center justify-center h-screen bg-cover min-h-screen" style={{ backgroundImage: 'url("/img/BgSuporte.jpg")'}}>
